...
//      });
    ...
    AnimationOnScroll: function(){
      var wow = new WOW( // jshint ignore:line
        {
    ...
    carouselSlider: function(){
      ...
      $('.js_widget-carousel').owlCarousel({
        ...
        navText : ["<span class='dotted-link2'><i class='fa fa-chevron-left'></i> <span>Prev</span></span>","<span class='dotted-link2'><span>Next</span> <i class='fa fa-chevron-right'></i></span>"] //jshint ignore:line
      });
      ...
      $('.js_one-slide').owlCarousel({
        ...
        navText : ["<span class='btn btn-primary btn-single-icon'><i class='fa fa-chevron-left'></i></span>","<span class='btn btn-primary btn-single-icon'><i class='fa fa-chevron-right'></i></span>"] //jshint ignore:line
      });
      ...
      $('.js_team-slider').owlCarousel({
        ...
        navText : ["<span class='link-circle'><i class='fa fa-angle-left'></i></span>","<span class='link-circle'><i class='fa fa-angle-right'></i></span>"] //jshint ignore:line
      });
    ...
    tooltipScript: function(){
      ...
      $('[data-toggle="tooltip"]').tooltip(); //jshint ignore:line
    ...
    filterButton: function(){
      ...
      $('#filterWrapper').on('shown.bs.collapse', function () {
        $('#filterTrigger').html('<i class="fa fa-toggle-on"></i><span>Close Options</span>'); //jshint ignore:line
      });

      $('#filterWrapper').on('hidden.bs.collapse', function () {
        $('#filterTrigger').html('<i class="fa fa-toggle-off"></i><span>Open Options</span>'); //jshint ignore:line
      });
    ...
    scrollNav: function(){
      ...
      var menuItem  = $('.navbar-nav.scroll-local li');

      $(window).scroll(function() {
        section.filter(':in-viewport:first').each(function() {
          var activeSection = $(this);
          var activeLink    = $('.navbar-nav.scroll-local li a[href="#' + activeSection.attr("id") + '"]'); //jshint ignore:line
